...
import {I_Генерация, ГенАлгоритм, ГенОбъект, ГенЗадание, ГенКоличество, ГенМесто} from "../interfaces/I_Генерация";
import {
    Регистр_НовыеПаллеты, Регистр_ПаллетаОткудаВЗадании,
    Регистр_ПаллетаКудаВЗадании, Регистр_ЗаданиеНаПриемку, Регистр_СвободныйОстаток

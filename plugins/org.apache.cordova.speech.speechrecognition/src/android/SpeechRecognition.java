...
public class SpeechRecognition extends CordovaPlugin {
    ...
    private void startRecognition() {
        ...
        //intent.putExtra(RecognizerIntent.EXTRA_CALLING_PACKAGE,"voice.recognition.test"); buhta
        //intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE,lang);
        intent.putExtra(RecognizerIntent.EXTRA_PREFER_OFFLINE,true);  //buhta
        //intent.putExtra(RecognizerIntent.EXTRA_ONLY_RETURN_LANGUAGE_PREFERENCE,true);  //buhta
